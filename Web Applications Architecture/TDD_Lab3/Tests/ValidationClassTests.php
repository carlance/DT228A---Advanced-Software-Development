...
class ValidationClassTests extends UnitTestCase {
	...
	public function testIsLenghtStringValid() {
		$this->assertFalse ( $this->validation->isLenghtStringValid ( "luca", "5" ) );
		$this->assertTrue ( $this->validation->isLenghtStringValid ( "luca", 6 ) );
		$this->assertFalse ( $this->validation->isLenghtStringValid ( "luca", 4 ) );
		$this->assertFalse ( $this->validation->isLenghtStringValid ( "luca", 4.6 ) );
		$this->assertFalse ( $this->validation->isLenghtStringValid ( 1, 5 ) );
		$this->assertFalse ( $this->validation->isLenghtStringValid ( "luca", "a" ) );
	}
}
?>